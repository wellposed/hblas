...
main = do
  ...
  (leftMat :: IODenseMatrix Row Float) <- unsafeThawDenseMatrix $! generateDenseMatrix SRow (5,5) (\_ -> 2.0 ::Float )
  (rightMat :: IODenseMatrix Row Float) <- unsafeThawDenseMatrix $! generateDenseMatrix SRow (5,5) (\_ -> 1.0 ::Float )
  (resMat :: IODenseMatrix Row Float) <- unsafeThawDenseMatrix $! generateDenseMatrix SRow (5,5) (\_ -> 1.0 ::Float )
